 ...
 * Returns a structured JSON response to the Angular frontend instead of a raw
 * error.
 */
@RestController
public class FallbackController {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> stockFallback() {
        return Mono.just(ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(Map.of(
                "error", "Stock Service is not available for now! Try later or contact Admin.",
    ...
    public Mono<ResponseEntity<Map<String, Object>>> userFallback() {
        return Mono.just(ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(Map.of(
                "error", "User Service is not available for now! Try later or contact Admin.",
    ...
    public Mono<ResponseEntity<Map<String, Object>>> technicianFallback() {
        return Mono.just(ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(Map.of(
                "error", "Technician Service is not available for now! Try later or contact Admin.",
    ...
    public Mono<ResponseEntity<Map<String, Object>>> employeeFallback() {
        return Mono.just(ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(Map.of(
                "error", "Employee Service is not available for now! Try later or contact Admin.",
    ...
    public Mono<ResponseEntity<Map<String, Object>>> itManagerFallback() {
        return Mono.just(ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(Map.of(
                "error", "IT Manager Service is not available for now! Try later or contact Admin.",
    ...
    public Mono<ResponseEntity<Map<String, Object>>> aiFallback() {
        return Mono.just(ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(Map.of(
                "error", "AI Service is not available for now! Try later or contact Admin.",
                "service", "ai-service",
