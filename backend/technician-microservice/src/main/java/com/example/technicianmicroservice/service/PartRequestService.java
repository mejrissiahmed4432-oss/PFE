...
public class PartRequestService {
    ...
    public PartRequest createRequest(PartRequest request) {
        ...
        if ("HIGH".equalsIgnoreCase(saved.getPriority())) {
            alertService.triggerSystemAlert(
                    ...
                    "Part request from " + saved.getRequesterName() + " is pending review. Priority: "
                            + saved.getPriority() + ".");
        } else {
    ...
    public PartRequest updateStatus(String requestId, String status) {
        ...
        // If stock-manager is DOWN, Circuit Breaker throws an exception here and blocks
        // execution,
    ...
    public void consumeParts(String requesterId,
        ...
        System.out.println("Forwarded consumption to Stock Manager: " + consumedParts.size() + " items for requester "
                + requesterId);
    }
