package com.example.itmanagermicroservice.exception;
...
/**
 * Global exception handler for the IT Manager Microservice.
 *
 * This class intercepts RuntimeExceptions thrown by Feign Client Fallbacks
 * (e.g., UserClientFallback, EmployeeClientFallback, TaskClientFallback)
...
public class GlobalExceptionHandler {
     ...
     * when a downstream microservice (user-microservice, employee-microservice) is down.
